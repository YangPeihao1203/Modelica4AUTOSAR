...
package autosar_swc_Example
  ...
  model autosar_swc
    ...
    RunnableEntity runnableEntity
      annotation (Placement(transformation(origin = {-97.52831606566906, 66.65625}, 
        extent = {{-18.471683934330954, -11.343749999999993}, {18.471683934330898, 11.34375}})));
    RunnableEntity3 runnableEntity3
      annotation (Placement(transformation(origin = {-193.66015625, -31.399999999999995}, 
        extent = {{-18.33984375, -10.000000000000004}, {18.33984375000003, 9.999999999999996}})));
    ...
    Utilities.DataStoreMemory dataStoreMemory
      annotation (Placement(transformation(origin = {42.14084483098592, -13.070422929577465}, 
        extent = {{-33.66197183098592, -15.859154929577468}, {33.66197183098591, 15.859154929577464}})));
    FunctionCaller1 functionCaller1_1
      annotation (Placement(transformation(origin = {14.64788728169016, -67.380282028169}, 
        extent = {{-26.450704225352112, -15.183098591549296}, {26.45070422535212, 15.183098591549296}})));
    annotation (Protection(access = Access.diagram));
  equation 
