model HeadLamp
  ...
  SIunits.Voltage voltage;   // Voltage of the car light (V)
  SIunits.Current current;   // Current of the car light (A)
  SIunits.Power power;       // Power of the car light (W)
  parameter SIunits.Resistance resistance = 10; // Resistance of the car light (Ω)
  parameter SIunits.Power P_max = 10; // Maximum power of the car light (W)
